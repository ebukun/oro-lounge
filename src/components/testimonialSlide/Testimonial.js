const Testimonial = () => {
    return (
        <div className="3xl:container testimonial-section lg:mb-10 bg-testimonials bg-center bg-no-repeat bg-cover">
            <div className=" flex flex-col justify-center py-28 px-12 lg:px-32">
                ...
                <div className="text-center carousel mt-8">
                    ...
                    <p className="text-whitish w-full font-barlow  mt-4 mb-4 mx-auto">
